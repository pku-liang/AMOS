...
def mapping_tensorcore(
    ...
    log_file = "scan-%s-%s-layer-%s.log" % (in_dtype, out_dtype, layer)
...
example_text = """
 example:
    python mapping_scan_tensorcore.py --in_dtype float16 --out_dtype float16 --begin 0 --num 1 --trials 20
    python mapping_scan_tensorcore.py --in_dtype float16 --out_dtype float32 --begin 0 --num 1 --trials 20
    python mapping_scan_tensorcore.py --in_dtype float32 --out_dtype float32 --begin 0 --num 1 --trials 20
    python mapping_scan_tensorcore.py --in_dtype float16 --out_dtype float16 --begin 0 --num 1 --trials 400 --simple_mode 0
"""
