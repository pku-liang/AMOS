...
def sublstm(input, targets, weight_ih, weight_hh, bias_ih, bias_hh, weight_for_classify, bias_for_classify, old_h, old_c):
  '''
  input: [batch_size, input_size]
  ...
  old_h  & old_c: [batch_size, state_size]
  '''
  new_h, new_c = internel_sublstm(input, weight_ih, weight_hh, bias_ih, bias_hh, old_h, old_c)
...
def main():
  ...
  # Helper list
  weight_to_update = [weight_ih, weight_hh, bias_ih, bias_hh, weight_for_classify, bias_for_classify]
  old_hc = [old_h, old_c]
  
  #Function
  loss, result, new_h, new_c = sublstm(img, label, *weight_to_update, *old_hc)
