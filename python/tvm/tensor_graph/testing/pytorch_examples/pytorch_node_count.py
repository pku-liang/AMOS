...
if __name__ == '__main__':
    ...
    import tvm.tensor_graph.testing.pytorch_examples.capsule_torch as models1
    model1 = models1.CapsuleNetwork()
    img1 = torch.empty(2, 1, 28, 28)
    output1 = model1(img1)
    node_count, node_names = count_nodes(output1) # 91

    import tvm.tensor_graph.testing.pytorch_examples.MILSTM as models2
    ...
    import tvm.tensor_graph.testing.pytorch_examples.shufflenet_v1_torch as models9
    model9 = models9.ShuffleNet()
    img9 = torch.empty(1, 3, 224, 224)
    output9 = model9(img9)
    node_count, node_names = count_nodes(output9) # 218

    import tvm.tensor_graph.testing.pytorch_examples.yolo_v1 as models10
