...
def kernel_gemm_general_perfect_bifrost_g71(tag="single_buffer"):
    def _kernel_gemm_general_perfect_bifrost_g71(
    ...
    return _kernel_gemm_general_perfect_bifrost_g71
