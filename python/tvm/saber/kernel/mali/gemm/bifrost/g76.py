...
def kernel_gemm_general_perfect_bifrost_g76(tag="single_buffer"):
    def _kernel_gemm_general_perfect_bifrost_g76(
        ...
        (
            ...
            schedule_func,
            parse_func
        ) = get_gemm_implementation_mali("general", "bifrost", "g76", tag)(
            [M1, N1, K1],
            threadblock_problem_size,
            warp_problem_size,
            instruction_problem_size,
    ...
    return _kernel_gemm_general_perfect_bifrost_g76
