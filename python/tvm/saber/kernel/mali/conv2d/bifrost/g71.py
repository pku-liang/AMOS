...
def kernel_conv2d_nchw_implicit_gemm_general_perfect_bifrost_g71(tag="single_buffer"):
    def _kernel_conv2d_nchw_implicit_gemm_general_perfect_bifrost_g71(
    ...
    return _kernel_conv2d_nchw_implicit_gemm_general_perfect_bifrost_g71
