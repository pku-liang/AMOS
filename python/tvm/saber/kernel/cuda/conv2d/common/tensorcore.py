...
def kernel_conv2d_nchw_implicit_gemm_tensorcore_perfect_common_common(arch, code, tag="single_buffer"):
    def _kernel_conv2d_nchw_implicit_gemm_tensorcore_perfect(
    ...
    return _kernel_conv2d_nchw_implicit_gemm_tensorcore_perfect


def kernel_conv2d_nhwc_implicit_gemm_tensorcore_perfect_common_common(arch, code, tag="single_buffer"):
    def _kernel_conv2d_nhwc_implicit_gemm_tensorcore_perfect(
        threadblock_problem_size,
        warp_problem_size,
        tensorize_problem_size,
        epilogues,
    ...
    return _kernel_conv2d_nhwc_implicit_gemm_tensorcore_perfect
