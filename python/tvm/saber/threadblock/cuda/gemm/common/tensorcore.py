...
def threadblock_gemm_tensorcore_common_common_single_buffer(get_tensorcore_recipe):
    def _threadblock_gemm_tensorcore(
    ...
    return _threadblock_gemm_tensorcore


def threadblock_gemm_tensorcore_split_K_common_common_single_buffer(get_tensorcore_recipe):
    def _threadblock_gemm_tensorcore_split_K(
        threadblock_problem_size,
        warp_problem_size,
        tensorize_problem_size,
        epilogues,
    ...
    return _threadblock_gemm_tensorcore_split_K
