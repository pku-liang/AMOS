...
def threadblock_gemm_general_bifrost_g71_single_buffer(
    Vars,
...
def threadblock_gemm_general_bifrost_g71_double_buffer(
    Vars,
    threadblock_problem_size,
    warp_problem_size,
    instruction_problem_size,
