...
@register_hw_abs_dag("opencl", "arm_dot_vlen_local")
class arm_dot_vlen_local_char4(HardwareAbstractionDAG):
    scope = InstructionScope.thread

    def __init__(self):
        self.hw_abs_dict = {"arm_dot": arm_dot_vlen_local}
        self.main_hw_abs_name = "arm_dot"
    ...
    def get_hw_abs_compute_expression(self, compute_key, shape_key, hw_abs_key):
        ...
        return hw_abs.get_compute_expression(reduction_len)
    
    def get_hw_abs_compute_expression_with_shape(self, reduction_len):
        """
        ---
        Returns:
        ...
        """
        hw_abs = self.hw_abs_dict["arm_dot"]
        return hw_abs.get_compute_expression(reduction_len)
    ...
    def get_intrinsic(self, compute_key, shape_key, hw_abs_key):
        ...
        hw_abs_class = self.hw_abs_dict[hw_abs_key]
        hw_abs = hw_abs_class(self.get_name())
        return hw_abs.get_intrinsic(L=reduction_len)
