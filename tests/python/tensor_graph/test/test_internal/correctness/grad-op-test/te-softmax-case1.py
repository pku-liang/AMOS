...
testing.assert_allclose(D_tvm.asnumpy(), D_torch.detach().numpy(), atol=1e-6*factor, rtol=1e-5)
testing.assert_allclose(dA_tvm.asnumpy(), A_torch.grad.numpy(), atol=1e-6*factor, rtol=1e-5)
