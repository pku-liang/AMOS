...
def consumer_process(target, dev_id, number=10, repeat=10, reference="", profile_level=0, change_layout=False):
  ...
  num_classes = 10
  depth = 30
  model = resnet_3d.resnet_3d(num_classes=num_classes, num_layers=18, depth=depth)
...
if __name__ == "__main__":
  ...
  parser.add_argument("--timeout", help="timeout in seconds", type=float, default=20) # customized
