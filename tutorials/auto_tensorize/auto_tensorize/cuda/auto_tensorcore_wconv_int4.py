...
def grouped_pointwise_conv2d(N, I, O, groups):
    ...
    A = tvm.te.placeholder([N, I], dtype="int4", name="A")
    B = tvm.te.placeholder([O, channel_per_group], dtype="int4", name="B")
...
def tensorize_tensorcore_fp16fp16(
    ...
    log_file = "wconv2d-int4-layer-%d-batch-%d.log" % (layer, N)
