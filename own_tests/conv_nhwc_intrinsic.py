...
# With intrinsic
print(s[BL].op.reduce_axis)
bl_ry, bl_rx, bl_rc = s[BL].op.reduce_axis
s[BL].tensorize(bl_rc, arm_dot_intrin(in_channel))
...
print('Convolution with intrinstic: %f ms' % (evaluator(a, w, b).mean * 1e3))
